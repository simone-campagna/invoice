...
__all__ = [
    ...
    'STATS_GROUPS',
    'DEFAULT_STATS_GROUP',
    'CUMULATE_MODE_INCOME'
    'CUMULATE_MODE_INVOICE_COUNT'
    'CUMULATE_MODES'
    'DEFAULT_CUMULATE_MODE',
    'RC_DIR_VAR',
    'DB_FILE_VAR',
    'RC_DIR_EXPR',
    'DB_FILE_EXPR',
...
CUMULATE_MODE_INCOME = 'income'
CUMULATE_MODE_INVOICE_COUNT = 'invoice_count'
CUMULATE_MODES = (CUMULATE_MODE_INCOME, CUMULATE_MODE_INVOICE_COUNT)
DEFAULT_CUMULATE_MODE = CUMULATE_MODE_INCOME
