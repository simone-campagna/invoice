...
_VERSION_STRING = '4.1.0'  ### bumpversion!
_VERSION_TUPLE = tuple(int(part) for part in _VERSION_STRING.split('.'))
VERSION_MAJOR = _VERSION_TUPLE[0]
VERSION_MINOR = _VERSION_TUPLE[1]
VERSION_PATCH = _VERSION_TUPLE[2]
